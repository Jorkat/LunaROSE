...
//-------------------------------------------------------------------------------------------------
// Custom bag/box result packet
//-------------------------------------------------------------------------------------------------
#define MAX_BAG_RESULT_ITEMS 10

struct tagBAG_RESULT_ITEM {
	int	m_iFullItemID;
	int	m_iQuantity;
};

struct gsv_BAG_RESULT : public t_PACKETHEADER {
	BYTE				m_btRewardCount;
	tagBAG_RESULT_ITEM	m_Rewards[MAX_BAG_RESULT_ITEMS];
};
...
struct t_PACKET {
	union {
		...
		*/
		...
		gsv_BAG_RESULT				m_gsv_BAG_RESULT;
